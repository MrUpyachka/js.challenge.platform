...
<div class="execution-details-box well well-sm">
    <div>
        <h5>Owner:</h5>
    ...
    <div class="script-body-wrapper well well-sm">
        <h5>Script:</h5>
        <code>${executionData.getBody()}</code>
    </div>
    <div class="script-result-wrapper well well-sm">
        <h5>Result:</h5>
        <code>${executionData.getResult()}</code>
    </div>
    <div class="script-output-wrapper well well-sm">
        <h5>Output:</h5>
